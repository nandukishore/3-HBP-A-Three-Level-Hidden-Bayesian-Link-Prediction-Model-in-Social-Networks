...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="mainbar">
          <h2 class="style5">All Users Posts Details</h2>
          <table width="687" border="1"  cellpadding="0" cellspacing="0"  >
            <tr bgcolor="#99CCCC">
              ...
              <td  width="51" height="34" valign="baseline" bgcolor="#00FFFF" style="color: #2c83b0;"><div align="center" class="style4" > Poster Name </div></td>
              <td  width="76" height="34" valign="baseline" bgcolor="#00FFFF" style="color: #2c83b0;"><div align="center" class="style4" > Post Image </div></td>
              <td  width="108" height="34" valign="baseline" bgcolor="#00FFFF" style="color: #2c83b0;"><div align="center" class="style4" >Post Name</div></td>
              <td  width="90" height="34" valign="baseline" bgcolor="#00FFFF" style="color: #2c83b0;"><div align="center" class="style4" >Posted Date</div></td>
              <td  width="91" height="34" valign="baseline" bgcolor="#00FFFF" style="color: #2c83b0;"><div align="center" class="style4" >SociRank </div></td>
              <td  width="226" height="34" valign="baseline" bgcolor="#00FFFF" style="color: #2c83b0;"><div align="center" class="style4" >Post Rate</div></td>
            </tr>
            ...
            <%
					...
					%>
            <tr>
              <td height="0"  valign="middle" bgcolor="#99FF33"><div align="center" class="style4" >
                  <div align="center">
                    <%out.println(i);%>
                  </div>
              </div></td>
              <td height="0"  valign="middle" bgcolor="#99FF33"><div align="center" class="style4" >
                  <div align="center"> <a href="A_UserProfile.jsp?uname=<%=s2%>&amp;type=<%="user1"%>">
                    <%out.println(s2);%>
                  </a> </div>
              </div></td>
              ...
              <td height="0"  valign="middle" bgcolor="#99FF33"><div align="center" class="style4"  >
                  <div align="center" > <a href="A_PostsDetails.jsp?id=<%=j%>&amp;type=<%="alltweets"%>&amp;tname=<%=s0%>">
                    <%out.println(s0);%>
                  </a> </div>
              </div></td>
              <td height="0"  valign="middle" bgcolor="#99FF33"><div align="center" class="style4" >
	    ...
	    %>
          ...
          <p>&nbsp;</p>
          <p>&nbsp;</p>
                <p class="pages style54"><strong><a href="adminmain.jsp">Back</a></strong></p>
          <div align="right"></div>
        </div>
        <p class="pages">&nbsp;</p>
      </div>
