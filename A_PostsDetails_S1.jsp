...
<head>
<title>Friends in same site</title>
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="index.html">Logout</a><a href="index.html"></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <div class="mainbar">
            <h2 class="style56">Post <%= request.getParameter("tname")%> Details...</h2>
            <p class="style6">&nbsp;</p>
            <p>
...
%>
            ...
            <table border="1" align="left" cellpadding="0" cellspacing="0"  width="479" >
              <tr >
                <td width="146" rowspan="9" bgcolor="#FFFFFF" ><div class="style22 style4 style5" style="margin:10px 13px 10px 13px;" >
                ...
                <td width="308" height="27" bgcolor="#FFFFFF" ><div align="center" class="style10 style7 style6"><strong>Uploader Name </strong></div></td>
                <td width="17" bgcolor="#FFFFFF"><div align="center" class="style8 style7"><strong><a href="A_UserProfile_S.jsp?uname=<%=s1%>&amp;type=<%=type%>&amp;id=<%=i%>&amp;name=<%=s0%>"><%= s1%></a></strong></div></td>
              </tr>
              <tr/></tr>
              <tr>
                <td></tr></td>
              ...
              <tr>
                <td width="146" height="27" bgcolor="#FFFFFF" ><div align="center" class="style10 style7 style6"><strong>Post Name </strong></div></td>
                <td bgcolor="#FFFFFF"><div align="center" class="style8 style7"><strong><%= s0%></strong></div></td>
              </tr>
              <tr>
                <td width="146" height="27" bgcolor="#FFFFFF"><div align="center" class="style10 style7 style6"><strong>Post Description </strong></div></td>
              ...
              <tr>
                <td width="146" height="27" bgcolor="#FFFFFF"><div align="center" class="style10 style7 style6"><strong>Post Uses </strong></div></td>
                <td bgcolor="#FFFFFF"><div align="center" class="style8 style7"><strong><%= s2%></strong></div></td>
              </tr>
              <tr>
                <td width="146" height="27" bgcolor="#FFFFFF"><div align="center" class="style10 style7 style6"><strong>Uploaded Date </strong></div></td>
                <td bgcolor="#FFFFFF"><div align="center" class="style8 style7"><strong><%= s4%></strong></div></td>
              </tr>
              <tr> </tr>
              <tr>
                <td width="146" height="27" bgcolor="#FFFFFF"><div align="center" class="style10 style7 style6"><strong>Post Rank </strong></div></td>
                <td bgcolor="#FFFFFF"><div align="center" class="style8 style7"><strong><%= rank%></strong></div></td>
              </tr>
              <tr>
                <td width="146" height="27" bgcolor="#FFFFFF"><div align="center" class="style10 style7 style6"><strong>Post Rate </strong></div></td>
                <td bgcolor="#FFFFFF"><div align="center" class="style8 style7"><strong>
                    <% 
	    ...
	    %>
            ...
            <h2 align="right">&nbsp;</h2>
            <p>&nbsp;</p>
            <h2 align="center" class="style56">&nbsp;</h2>
            ...
            <p align="center" class="style56">&nbsp;</p>
            <p></p>
            <table width="547" border="1.5"  cellpadding="0" cellspacing="0" >
              <tr bgcolor="#FFFFFF">
                ...
                <td width="80" height="44" valign="middle" style="color: #2c83b0;"><div align="left" class="style7 style14 style5 style6" style="margin-left:20px;"><strong> Review User</strong></div></td>
                <td width="80" height="44" valign="middle" style="color: #2c83b0;"><div align="left" class="style7 style14 style5 style6" style="margin-left:20px;"><strong> Review </strong></div></td>
              ...
              <tr>
                ...
                <%}else{%>
                <td  width="182" height="44" valign="middle" bgcolor="#FFFFFF" style="color:#000000;"><div align="left" class="style10 style7 style9 style2" style="margin-left:20px;"><strong><em><a href="A_UserProfile_S.jsp?uname=<%=c_user%>&amp;type=<%=type%>&amp;id=<%=one%>&amp;name=<%=s0%>">
                    <%out.println(c_user);%>
                </a></em></strong></div></td>
                <%}%>
                <td  width="182" height="44" valign="middle" bgcolor="#FFFFFF" style="color:#000000;"><div align="left" class="style10 style7 style9 style2" style="margin-left:20px;"><strong><em>
        ...
        <p class="pages"><strong><a href="A_AllusersPosts_S.jsp">Back</a></strong></p>
      </div>
      <div class="sidebar">
