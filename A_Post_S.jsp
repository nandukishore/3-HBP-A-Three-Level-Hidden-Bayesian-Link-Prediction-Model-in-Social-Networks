...
%>
        ...
        <table border="1" align="center" cellpadding="0" cellspacing="0"  width="600" >
          <tr >
            ...
            <td width="316" bgcolor="#FFFFFF"><div align="center" class="style8 style7"><strong><a href="A_UserProfile_S.jsp?uname=<%=s1%>&amp;type=<%=type%>&amp;id=<%=i%>&amp;name=<%=s0%>"><%= s1%></a></strong></div></td>
          </tr>
          <tr/></tr>
          <tr>
        ...
        <table width="547" border="1.5" align="center"  cellpadding="0" cellspacing="0" >
          <tr bgcolor="#FFFFFF">
            <td width="127" height="44" valign="middle" style="color: #FFFFFF;"><div align="left" class="style5 style14 style7 style6" style="	margin-left:20px;"><strong><strong>Image</strong></strong></div></td>
            <td width="80" height="44" valign="middle" style="color:#FFFFFF;"><div align="left" class="style7 style14 style5 style6" style="margin-left:20px;"><strong> Reviewed User</strong></div></td>
            <td width="80" height="44" valign="middle" style="color: #FFFFFF;"><div align="left" class="style7 style14 style5 style6" style="margin-left:20px;"><strong> Reviews </strong></div></td>
            <td width="80" height="44" valign="middle" style="color: #FFFFFF;"><div align="left" class="style7 style14 style5 style6" style="margin-left:20px;"><strong> Reviewed Date </strong></div></td>
          </tr>
          <%
