    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <form id="form1" name="form1" method="post" action="admin1.jsp">
            <p>&nbsp;</p>
            <table width="446" border="0" align="left" cellpadding="2" cellspacing="2">
              ...
              <tr>
                <td height="40" align="center"><span class="style8">Password (required)</span></td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><div align="right"><a href="index.html" class="style11"></a></div></td>
              </tr>
            </table>
          </form>
        </div>
        ...
        <p class="pages"><a href="index.html" class="style11"><strong>Back</strong></a></p>
      </div>
      <div class="sidebar">
          ...
          <div class="g2">
            <div class="gadget">
              ...
              <ul class="sb_menu">
                ...
                <li><a href="index.html">Logout</a><a href="userlogin.jsp"></a></li>
              </ul>
            </div>
          </div>
        </div>
