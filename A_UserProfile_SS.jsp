...
<tr>			 <td  width="141" height="47" align="left" valign="middle" style="color: #2c83b0;"><div align="left" class="style15 style42 style60 style61 style7 style8 style5" style="margin-left:10px;"><strong>Social Network</strong></div></td>
			<td  width="158" align="left" valign="middle" ><div align="left" class="style40 style62 style4 style3 style7 style9 style5" style="margin-left:10px;"><strong>
                <%out.println(s55);%>
            </strong></div></td>
          </tr>
        ...
        <p><span class="style12 style5"><a href="UserMain.jsp">Back</a></span></p>
      </div>
      <div class="sidebar">
