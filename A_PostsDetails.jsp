...
<head>
<title>User Posts Deatails</title>
...
%>
	    ...
	    %>
            ...
            <h2 align="right"><a href="A_Relevent.jsp" class="style4"></a></h2>
            <%}
			else if(type.equalsIgnoreCase("alltweets")){%>
            <h2 align="right"><a href="A_AllUserTweets.jsp" class="style4"></a></h2>
            <%}
			else if(type.equalsIgnoreCase("cluster")){%>
            <h2 align="right"><a href="A_ClustersByUname.jsp" class="style4"></a></h2>
            <%}
			else if(type.equalsIgnoreCase("allfrqtweets")){%>
            <h2 align="right"><a href="A_TweetFreqCount.jsp" class="style4"></a></h2>
            <%}
			else if(type.equalsIgnoreCase("outlier")){%>
            <h2 align="right"><a href="A_OutlierTweets.jsp" class="style4"></a></h2>
            <%}
        ...
        <p class="pages"><strong><a href="A_AllusersPosts.jsp">Back</a></strong></p>
      </div>
      <div class="sidebar">
