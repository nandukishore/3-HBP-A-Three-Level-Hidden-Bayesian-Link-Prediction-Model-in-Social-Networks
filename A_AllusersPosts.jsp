        ...
        <div class="mainbar">
          ...
          <table width="687" border="1"  cellpadding="0" cellspacing="0"  >
            <tr bgcolor="#99CCCC">
              ...
              <td  width="91" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #2c83b0;"><div align="center" class="style4" >Post Rank </div></td>
            ...
            <tr>
              ...
              <td height="0"  valign="middle" bgcolor="#FFFFFF"><div align="center" class="style4" >
                  <div align="center"> <a href="A_UserProfile_SS.jsp?uname=<%=s2%>&amp;type=<%="user1"%>">
                    <%out.println(s2);%>
                  </a> </div>
              </div></td>
              ...
              <td height="0"  valign="middle" bgcolor="#FFFFFF"><div align="center" class="style4"  >
                  <div align="center" > <a href="A_PostsDetails_U.jsp?id=<%=j%>&amp;type=<%="alltweets"%>&amp;tname=<%=s0%>">
                    <%out.println(s0);%>
                  </a> </div>
              </div></td>
              <td height="0"  valign="middle" bgcolor="#FFFFFF"><div align="center" class="style4" >
