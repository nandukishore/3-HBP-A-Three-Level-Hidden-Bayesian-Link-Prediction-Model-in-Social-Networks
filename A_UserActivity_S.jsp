  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <div class="mainbar">
            <h2 class="style5">All <%out.println(application.getAttribute("site"));%> Posts Details In Clusters Form...</h2>
            <%
	...
	try
	{
	    ...
	    %>
                ...
                <td width="174" height="0" bgcolor="#FFFFFF"  style="color:#000000;"><div align="center" ><strong> <a href="A_Post_S.jsp?id=<%=i%>&amp;tname=<%=s1%>&amp;type=<%="cluster"%>"> Post Details </a> </strong></div></td>
                <td width="174" height="0" bgcolor="#FFFFFF"  style="color:#000000;"><div align="center" ><strong> <a href="A_ActiReviews_S.jsp?id=<%=i%>&amp;type=<%="clusters"%>"> Reviews Details </a> </strong></div></td>
              </tr>
              <%
					 }
	...
	%>
        ...
        <p class="pages"><strong><a href="SocialMain.jsp">Back</a></strong></p>
      </div>
      <div class="sidebar">
